...
- **Frontend & Architecture**: Vue 3, TypeScript, Tailwind CSS, Schema-Driven UI, State Management.
- **Backend & AI Integration**: Node.js, Express, Fastify, RESTful APIs, Google Gemini API, Prompt Engineering, Agentic Workflows.
- **DevOps & Tooling**: Vitest, Docker, CI/CD Pipelines, Git, n8n, Webpack/Vite.
...
### Corporate Instructor | Takming University of Science and Technology | 2021 – Present

- Designed and delivered comprehensive technical curricula (Vue.js, RESTful APIs, Git) to 120+ students, bridging the gap between academic theories and modern industry standards.
- Pioneered a Prompt Engineering & AI-Assisted Development course utilizing n8n and LLMs, teaching students to integrate AI agents into workflows while cultivating independent problem-solving skills.

## EDUCATION

**Bachelor of Management Information Systems** | Takming University of Science and Technology
